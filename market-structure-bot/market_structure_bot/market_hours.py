...
This does not account for NSE trading holidays (Diwali, Republic Day, etc.)
since that list changes yearly and would need its own maintained source; it
only checks weekday + time-of-day.
"""
